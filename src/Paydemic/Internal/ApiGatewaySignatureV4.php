...
/**
 * API Gateway Signature Version 4
 * @link http://docs.aws.amazon.com/general/latest/gr/signature-version-4.html
 */
class ApiGatewaySignatureV4 implements SignatureInterface
{
    use SignatureTrait;
    ...
    public function signRequest(
        ...
        $parsed['headers']['Authorization'] = [
            "AWS4-HMAC-SHA256 Credential={$credentials->getAccessKeyId()}/{$cs}, SignedHeaders={$context['headers']}, Signature={$signature}"
        ];
    ...
    public static function convertPostToGet(RequestInterface $request)
    {
        if ($request->getMethod() !== 'POST') {
            throw new \InvalidArgumentException('Expected a POST request but received a '
